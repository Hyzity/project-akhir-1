            ...
            <div class="row">
                <div class="col-12">
                    <div class="container-fluid" style="padding-bottom: 50px;">
                        <h1
                            style="text-align: center; padding: 25px 0; box-shadow: #33333323 3px 5px 2px; border: #33333345 1px solid; background-color: white;">
                            Data Guru</h1>
                    </div>
                </div>
            </div>
            ...
            <div class="row container">
                @forelse ($guru as $g)
                    <div class="col-12 col-md-6 col-lg-3 mb-4 d-flex align-items-stretch">
                        <div class="card w-100 hover-effect"
                            style="transition: transform 0.3s, box-shadow 0.3s; border: 1px solid #ddd;">
                            <a href="{{ route('guru.show', $g->id) }}">
                                <div class="card-img-container">
                                    @if ($g->foto)
                                        <img src="{{ asset('uploads/img/guru/' . $g->foto) }}" class="card-img-top"
                                            alt="Guru Thumbnail">
                                    @else
                                        <img src="{{ asset('img/guru/default.jpg') }}" class="card-img-top"
                                            alt="Guru Thumbnail">
                                    @endif
                                </div>
                                <div class="card-body">
