...
<style>
  ...
  .small-box-footer:hover i {
    ...
    /* Translasi ikon ke kanan saat hover */
  }
...
<div class="container my-5">
  <div class="container-fluid" style="padding: 150px 0 30px 0;">
    ...
    <div class="row mt-5">
      @foreach($kelas as $p)
      <div class="col-lg-3 col-5" style="padding: 20px;">
        <div class="small-box bg-info">
          <div class="inner mb-3"">
          <h3 style=" color: white;">Kelas {{ $p->nama_kelas }} <span class="icon"><i class="fas fa-school"></i></span></h3>
          </div>
