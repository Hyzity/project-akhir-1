                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="file" name="file" class="dropify form-control" data-height="190"
                                    ...
                                    @if ($artikel->thumbnail) data-default-file="{{ asset('uploads/img/artikel/' . $artikel->thumbnail) }}" @endif>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="kategori_artikel_id">Kategori Artikel</label>
                                <select required class="form-control" name="kategori_artikel_id" id="kategori_artikel_id">
                                    <option disabled {{ is_null($artikel->kategori_artikel_id) ? 'selected' : '' }}>- PILIH KATEGORI -</option>
