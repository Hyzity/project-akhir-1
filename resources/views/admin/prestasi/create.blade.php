        ...
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data" action="{{ route('admin.fasilitas.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input required type="text" name="deskripsi" placeholder="Masukkan Deskripsi" class="form-control">
                </div>
                <div class="form-group">
                    <label for="nama_fasilitas">Nama Fasilitas</label>
                    <input required type="text" name="nama_fasilitas" placeholder="Masukkan Nama Fasilitas" class="form-control">
                </div>
                <div class="form-group">
